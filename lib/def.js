...
(function(mod) {
  ...
  function isSimpleAnnotation(spec) {
    ...
    for (var prop in spec)
      if (prop != "!type" && prop != "!doc" && prop != "!url" && prop != "!span" && prop != "!data" && prop != "!hint" && prop != "!backPropagate")
        return false;
    return true;
  }
  ...
  function passTwo(base, spec, path) {
    ...
    for (var name in spec) if (hop(spec, name) && name.charCodeAt(0) != 33) {
      ...
      if (typeof inner == "string") {
        ...
        if (inner["!backPropagate"]) known.backPropagate = inner["!backPropagate"];
  ...
  function copyInfo(spec, type) {
    ...
    if (spec["!backPropagate"]) type.backPropagate = spec["!backPropagate"];
  }
